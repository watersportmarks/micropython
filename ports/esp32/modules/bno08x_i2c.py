...
DEFAULT_REPORT_INTERVAL = 50000 #20000
...
AVAIL_SENSOR_REPORTS = {
    ...
    BNO_REPORT_ROTATION_VECTOR: (Q_POINT_14_SCALAR, 5, 14),
...
class BNO08X_I2C:
    ...
    def _process_available_packets(self, max_packets=None):
        ...
        self._dbg("")
        #print("processed packets = " + str(processed_count))
    ...
    def _process_report(self, report_id, report_bytes):
        ...
        #print("\tProcessing report:", REPORTS_DICTIONARY[report_id])
    ...
    def _read_packet(self):
        ...
        #if self._data_buffer[4] in REPORTS_DICTIONARY:
        #    print("Report Type: " + str(REPORTS_DICTIONARY[self._data_buffer[4]]))
